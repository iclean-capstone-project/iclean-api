...
public class RegisterEmployeeController {
    ...
    public ResponseEntity<ResponseObject> getRegisterEmployees(@RequestParam @Valid GetEmployeeInformationRequestDTO request) {
    ...
    public ResponseEntity<ResponseObject> createRegisterEmployee(@RequestBody @Valid CreateEmployeeInformationRequestDTO request) {
    ...
    public ResponseEntity<ResponseObject> updateRegisterEmployee(@RequestBody @Valid UpdateEmployeeInformationRequestDTO request,
